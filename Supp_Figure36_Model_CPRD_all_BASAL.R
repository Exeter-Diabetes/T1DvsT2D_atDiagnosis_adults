...
pdf("figures/Supp_Figure35.pdf", height = 16, width = 24)
...
print(joint_plot)
dev.off()
#ggsave("figures/Figure5_basal.png", joint_plot, height = 16, width = 24)
ggsave("figures/Supp_Figure35.jpeg", joint_plot, height = 16, width = 24)

...
var_characteristics(varlist = varlist_3, 
                    ...
                    table_name = "tables/Sup_table_5_SR_medianIQR",
...
var_characteristics(varlist = varlist_3, 
                    ...
                    dataset = SR_50_ro_cc,
                    numeric_option = "medianIQR",
                    table_name = "tables/Sup_table_5_SR_medianIQR_all",
                    p_value_testing = FALSE)
...
var_characteristics(varlist = varlist_12, 
                    ...
                    numeric_option = "medianIQR",
                    group = "robust_outcome",
                    table_name = "tables/Sup_table_5_m12_medianIQR",
                    p_value_testing = FALSE, 
                    missingness = FALSE)
...
var_characteristics(varlist = varlist_12, 
                    ...
                    dataset = SR_m12_data,
                    numeric_option = "medianIQR",
                    table_name = "tables/Sup_table_5_m12_medianIQR_all",
                    p_value_testing = FALSE, 
                    missingness = FALSE)
...
var_characteristics(varlist = varlist_12, 
                    ...
                    numeric_option = "medianIQR",
                    group = "robust_outcome",
                    table_name = "tables/Sup_table_5_m12_anti_medianIQR",
                    p_value_testing = FALSE, 
                    missingness = TRUE)
...
var_characteristics(varlist = varlist_12, 
                    ...
                    numeric_option = "medianIQR",
                    group = "Gender_v1",
                    table_name = "tables/Sup_table_5_m12_T1D_anti_medianIQR",
                    p_value_testing = FALSE, 
                    missingness = FALSE)
var_characteristics(varlist = varlist_12, 
                    varlist_cat = varlist_cat_12_anti,
                    ...
                    numeric_option = "medianIQR",
                    group = "Gender_v1",
                    table_name = "tables/Sup_table_5_m12_T2D_anti_medianIQR",
                    p_value_testing = FALSE, 
                    missingness = FALSE)
##Model3 -----------------------------------------------------------------------------
var_characteristics(varlist = varlist_3, 
                    ...
                    numeric_option = "medianIQR",
                    group = "robust_outcome",
                    table_name = "tables/Sup_table_5_m3_medianIQR",
                    p_value_testing = FALSE, 
                    missingness = FALSE)
var_characteristics(varlist = varlist_3, 
                    varlist_cat = varlist_cat_3,
                    dataset = SR_m3_data,
                    numeric_option = "medianIQR",
                    table_name = "tables/Sup_table_5_m3_medianIQR_all",
                    p_value_testing = FALSE, 
                    missingness = FALSE)
var_characteristics(varlist = varlist_3, 
                    varlist_cat = varlist_cat_12_anti,
                    ...
                    numeric_option = "medianIQR",
                    group = "Gender_v1",
                    table_name = "tables/Sup_table_5_m3_T1D_anti_medianIQR",
                    p_value_testing = FALSE, 
                    missingness = FALSE)
var_characteristics(varlist = varlist_3, 
                    varlist_cat = varlist_cat_12_anti,
                    ...
                    numeric_option = "medianIQR",
                    group = "Gender_v1",
                    table_name = "tables/Sup_table_5_m3_T2D_anti_medianIQR",
                    p_value_testing = FALSE, 
                    missingness = FALSE)
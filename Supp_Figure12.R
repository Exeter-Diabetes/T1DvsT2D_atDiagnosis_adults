...
dat_text_m3 <- dat_text_m3 %>%
  mutate(auc_full = "AUCROC: 0.90 (0.83;0.97)")
...
model_display_item <- patchwork::wrap_plots(
  ...
  ncol = 1, nrow = 4
                                                   ...
                                                   "", "J", "K", "L")))
# Save outputs ----------------------------------------------------------------------
pdf("~/PhD/StartRight_paper/T1DvsT2D_atDiagnosis_adults/neat/AI_neat/figures/Supp_Figure12.pdf", height = 20, width = 16)
print(model_display_item)
dev.off()

ggsave("~/PhD/StartRight_paper/T1DvsT2D_atDiagnosis_adults/neat/AI_neat/figures/Supp_Figure12.jpeg", model_display_item, height = 20, width = 16)

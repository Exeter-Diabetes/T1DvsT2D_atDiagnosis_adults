...
model_info(model = m1, 
           test_data = SR_neg_12, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm1_anti_neg", 
...
model_info(model = m2, 
           test_data = SR_neg_12, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm2_anti_neg", 
           manual_plotting = TRUE, 
           manual_plot_name = "m2")
...
model_info(model = m3, 
           test_data = SR_neg_3, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm3_anti_neg", 
           manual_plotting = TRUE, 
           manual_plot_name = "m3")
...
m1_plots_abc <- patchwork::wrap_plots(
  ...
  #boxplot
  ggplot(SR_neg_12, aes(x=factor(SRoutcome, 
                                 levels = c("1","0"), 
...
m3_plots_abc <- patchwork::wrap_plots(
  ...
  #boxplot
  ggplot(SR_neg_3, aes(x=factor(SRoutcome, 
                                levels = c("1","0"), 
                                labels = c("Type 1", "Type 2")), 
                       y = pred_prob_m3)) +
    geom_violin() + 
...
####PDF
pdf("figures/Supp_Figure12_all.pdf", height = 15, width = 16)
...
pdf("figures/Supp_Figure12_23.pdf", height = 10, width = 16)
model_display_item <- patchwork::wrap_plots(
  #m1_plots_abc,
  m2_plots_abc,
  m3_plots_abc,

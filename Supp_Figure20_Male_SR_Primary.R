...
dat_text_m1 <- dat_text_m1 %>%
  mutate(auc_full = "AUCROC: 0.92 (0.90;0.95)")
...
####PDF
# pdf("figures/Supp_Males.pdf", height = 15, width = 16)
...
pdf("figures/Supp_Figure20.pdf", height = 20, width = 16)
model_display_item <- patchwork::wrap_plots(
  m1_plots_abc,
  m2_plots_abc,
  m3_plots_abc,
...
print(model_display_item)
dev.off()
ggsave("figures/Supp_Figure20.jpeg", model_display_item, height = 20, width = 16)

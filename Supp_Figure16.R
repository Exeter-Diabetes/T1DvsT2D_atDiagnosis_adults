...
model_info(model = m1, 
           test_data = SR_Non_White_12, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm1_Non_White", 
...
model_info(model = m2, 
           test_data = SR_Non_White_12, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm2_Non_White", 
           manual_plotting = TRUE, 
           manual_plot_name = "m2")
...
####Get large amount of model info automated
model_info(model = m3, 
           test_data = SR_Non_White_3, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm3_Non_White", 
           manual_plotting = TRUE, 
           manual_plot_name = "m3")
...
11111#
  ...
  223344
"
m12_n <- nrow(SR_Non_White_12)
m3_n <- nrow(SR_Non_White_3)
...
m1_plots_abc <- patchwork::wrap_plots(
  ...
  #boxplot
  ggplot(SR_Non_White_12, aes(x=factor(SRoutcome, 
                                       levels = c("1","0"), 
...
m3_plots_abc <- patchwork::wrap_plots(
  ...
  #boxplot
  ggplot(SR_Non_White_3, aes(x=factor(SRoutcome, 
                                      levels = c("1","0"), 
                                      labels = c("Type 1", "Type 2")), 
                             y = pred_prob_m3)) +
    geom_violin() + 
...
####PDF
pdf("figures/Supp_Figure16.pdf", height = 15, width = 16)

...
SR_SRout_ccc$num_anti <- as.character(SR_SRout_ccc$num_anti)
#Model12
...
#StartRight Prime -------------------------------------------------------------------
###Antibodies only ------------------------------------------------------------------------
m_50_antis <- glm(SRoutcome ~ num_anti,
                  data = SR_50_m12_data,
                  family = binomial)
###GRS only -------------------------------------------------------------------------------
m_50_grs <- glm(SRoutcome ~ scale(T1DGRS2_z) ,
                data = SR_50_m3_data,
                family = binomial)
...
write_xlsx(model_summary,"tables/Supp_Table14_SR_Primary.xlsx")
...
write_xlsx(model_summary,"tables/Supp_Table14_Prime_Primary.xlsx")

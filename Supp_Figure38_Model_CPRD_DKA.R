...
plotA <- ggplot(`2_ci`,
  ...
  theme_bw()  +
  geom_text(aes(y = -1.5, label = mean), vjust = 1, size = 6) +
  annotate("text", x = 0.35, y = -1.5, label = "Mean \n prob.", size = 6, vjust = 1, hjust = 1, lineheight = 0.5) +
  coord_cartesian(xlim = c(1, 2), ylim = c(-1.5, 15), clip = "off") +
...
pdf("figures/Supp_Figure37.pdf", height = 16, width = 24)
...
print(joint_plot)
dev.off()
#ggsave("figures/Supp_Figure37_DKA.png", joint_plot, height = 16, width = 24)
ggsave("figures/Supp_Figure37.jpeg", joint_plot, height = 16, width = 24)

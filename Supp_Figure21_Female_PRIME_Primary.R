...
pdf("figures/Supp_Figure21.pdf", height = 20, width = 16)
model_display_item <- patchwork::wrap_plots(
  m1_plots_abc,
  m2_plots_abc,
  m3_plots_abc,
...
print(model_display_item)
dev.off()
ggsave("figures/Supp_Figure21.jpeg", model_display_item, height = 20, width = 16)

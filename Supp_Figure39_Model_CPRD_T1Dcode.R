...
pdf("figures/Supp_Figure38.pdf", height = 16, width = 24)
...
print(joint_plot)
dev.off()
#ggsave("figures/Supp_Figure38_T1Dcode.png", joint_plot, height = 16, width = 24)
ggsave("figures/Supp_Figure38.jpeg", joint_plot, height = 16, width = 24)

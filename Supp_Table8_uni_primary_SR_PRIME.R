...
model_continuous(varlist,
                 ...
                 outcome = "SRoutcome",
                 saving_name = "tables/Supp_Table8_SR_cont",
                 complete_case = TRUE,
...
model_continuous(varlist,
                 ...
                 outcome = "SRoutcome",
                 saving_name = "tables/Supp_Table8_Prime_cont",
                 complete_case = TRUE,
                 thresholds = tbl1_thresholds,
                 plots = FALSE)
varlist <- c(
...
model_continuous(varlist,
                 dataset = SR_50_SRout_ccc,
                 outcome = "SRoutcome",
                 saving_name = "tables/Supp_Table8_Prime_cont_nothresholds",
                 complete_case = TRUE,
                 #thresholds = tbl1_thresholds,
                 plots = FALSE)
...
`tables/Supp_Table8_SR_cont` <- full_join(`tables/Supp_Table8_SR_cont`, sum_table)
write_xlsx(`tables/Supp_Table8_SR_cont`, "tables/Supp_Table8_SR_cont.xlsx")
...
SR_50_SRout_ccc$cut_threshold <- ifelse(SR_50_SRout_ccc$wh_ratio_v1 < 0.94,
                                 "1",
                                 "0")
SR_50_SRout_ccc$SRoutcome_rev <- ifelse(SR_50_SRout_ccc$SRoutcome == "1", 0, 1)
#Assign model summary information to summary data.frame

conf_matrix <- confusion_matrix(SR_50_SRout_ccc$SRoutcome_rev,
                                SR_50_SRout_ccc$wh_ratio_v1,
                                thresholds = threshold)
specif <- conf_matrix$cm_stats["sensitivity"]*100
specif_lci <- conf_matrix$cm_stats["sensitivity_lcl"]*100
...
`tables/Supp_Table8_Prime_cont` <- full_join(`tables/Supp_Table8_Prime_cont`, sum_table)
write_xlsx(`tables/Supp_Table8_Prime_cont`, "tables/Supp_Table8_Prime_cont.xlsx")
...
cat_contingency(varlist_cat,
                dataset = SR_50_SRout_ccc,
                outcome = "SRoutcome",
                saving_name = "tables/Supp_Table8_Prime_cat",
                complete_case = TRUE,
                plots = FALSE,
                decimals = 3)

...
# StartRight Prime dataset (18-50s)
...
dat_text_m1 <- dat_text_m1 %>%
  mutate(auc_full = "AUCROC: 0.60 (0.24;0.95)")
dat_text_m2 <- dat_text_m2 %>%
  mutate(auc_full = "AUCROC: 0.75 (0.44;1.00)")
dat_text_m3 <- dat_text_m3 %>%
  mutate(auc_full = "AUCROC: 0.75 (0.43;1.00)")
...
model_display_item <- patchwork::wrap_plots(
  ...
  ncol = 1, nrow = 4
                                                   ...
                                                   "", "J", "K", "L")))
# Save outputs ----------------------------------------------------------------------
pdf("~/PhD/StartRight_paper/T1DvsT2D_atDiagnosis_adults/neat/AI_neat/figures/Supp_Figure13.pdf", height = 20, width = 16)
print(model_display_item)
dev.off()

ggsave("~/PhD/StartRight_paper/T1DvsT2D_atDiagnosis_adults/neat/AI_neat/figures/Supp_Figure13.jpeg", model_display_item, height = 20, width = 16)

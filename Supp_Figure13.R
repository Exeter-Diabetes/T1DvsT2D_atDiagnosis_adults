...
##Antibody categories-------------------------------------------------------------------
###Antibody positive: 1-------------------------------------------------------------------
SR_pos1_12 <- SR_m12_data %>%
  filter(num_anti == "1")
SR_pos1_3 <- SR_m3_data %>%
  filter(num_anti == "1")
####Model 1 ROW --------------------------------------------------------------------------
####Get large amount of model info automated
model_info(model = m1, 
           test_data = SR_pos1_12, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm1_anti_pos1", 
...
model_info(model = m2, 
           test_data = SR_pos1_12, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm2_anti_pos1", 
           manual_plotting = TRUE, 
           manual_plot_name = "m2")
...
model_info(model = m3, 
           test_data = SR_pos1_3, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm3_anti_pos1", 
           manual_plotting = TRUE, 
           manual_plot_name = "m3")
...
m1_plots_abc <- patchwork::wrap_plots(
  ...
  #boxplot
  ggplot(SR_pos1_12, aes(x=factor(SRoutcome, 
                                  levels = c("1","0"), 
...
m3_plots_abc <- patchwork::wrap_plots(
  ...
  #boxplot
  ggplot(SR_pos1_3, aes(x=factor(SRoutcome, 
                                 levels = c("1","0"), 
                                 labels = c("Type 1", "Type 2")), 
                        y = pred_prob_m3)) +
    geom_violin() + 
...
####PDF
pdf("figures/Supp_Figure13_pos1_all.pdf", height = 15, width = 16)
...
dev.off()
####PDF
pdf("figures/Supp_Figure13_pos1_23.pdf", height = 10, width = 16)
model_display_item <- patchwork::wrap_plots(
  #m1_plots_abc,
  m2_plots_abc,
  m3_plots_abc,
...
###Antibody positive: 2+-------------------------------------------------------------------
SR_pos2_12 <- SR_m12_data %>%
  filter(num_anti == "2" | num_anti == "3")
SR_pos2_3 <- SR_m3_data %>%
  filter(num_anti == "2" | num_anti == "3")
####Model 1 ROW --------------------------------------------------------------------------
####Get large amount of model info automated
model_info(model = m1, 
           test_data = SR_pos2_12, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm1_anti_pos2", 
           manual_plotting = TRUE, 
           manual_plot_name = "m1")
...
model_info(model = m2, 
           test_data = SR_pos2_12, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm2_anti_pos2", 
           manual_plotting = TRUE, 
           manual_plot_name = "m2")
...
model_info(model = m3, 
           test_data = SR_pos2_3, 
           outcome = "SRoutcome",
           saving_name = "03_05_sm3_anti_pos2", 
           manual_plotting = TRUE, 
           manual_plot_name = "m3")
...
m1_plots_abc <- patchwork::wrap_plots(
  ...
  #boxplot
  ggplot(SR_pos2_12, aes(x=factor(SRoutcome, 
                                  levels = c("1","0"), 
                                  labels = c("Type 1", "Type 2")), 
                         y = pred_prob_m1)) +
    geom_violin() + 
...
m3_plots_abc <- patchwork::wrap_plots(
  ...
  #boxplot
  ggplot(SR_pos2_3, aes(x=factor(SRoutcome, 
                                 levels = c("1","0"), 
                                 labels = c("Type 1", "Type 2")), 
                        y = pred_prob_m3)) +
    geom_violin() + 
...
####PDF
pdf("figures/Supp_Figure13_pos2_all.pdf", height = 15, width = 16)
model_display_item <- patchwork::wrap_plots(
  m1_plots_abc,
  m2_plots_abc,
  m3_plots_abc,
...
####PDF
pdf("figures/Supp_Figure13_pos2_23.pdf", height = 10, width = 16)
model_display_item <- patchwork::wrap_plots(
  #m1_plots_abc,
  m2_plots_abc,
  m3_plots_abc,

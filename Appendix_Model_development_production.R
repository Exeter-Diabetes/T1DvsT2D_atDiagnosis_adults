...
#            outcome = "SRoutcome",
#            saving_name = "Appendix_m1",
#            manual_plotting = TRUE,
#            manual_plot_name = "m1")
# model_info(model = m1_alt,
#            test_data = SR_m12_data,
#            outcome = "SRoutcome",
#            saving_name = "Appendix_m1_alt",
#            manual_plotting = TRUE,
...
#            test_data = SR_m3_data,
#            outcome = "SRoutcome",
#            saving_name = "Appendix_m4",
#            manual_plotting = TRUE,
#            manual_plot_name = "m4")
#
# ####Forest estimates plots
# coefs_clean_m4 <- coefs_m4 %>%
#   mutate(
#     var_type = if_else(str_detect(variable,
#                                   "^scale\\("),
#                        "continuous",
...
#
# # Step 2: Split into continuous and categorical
# cont_m4 <- coefs_clean_m4 %>%
#   filter(var_type == "continuous") %>%
#   arrange(desc(sort_key))
# cat_m4 <- coefs_clean_m4 %>%
#   filter(var_type == "categorical") %>%
#   arrange(desc(sort_key))
#
# # Step 3: Create break row using a copy of an existing row
# break_row_m4 <- cont_m4[1, ]
# break_row_m4[] <- NA  # set all values to NA
# break_row_m4$variable_clean <- " "
# break_row_m4$var_type <- "break"
# break_row_m4$sort_key <- "zzzzzzzz"  # ensures it's last if sorted again
#
# # Step 4: Bind and set factor levels
# coefs_ordered_m4 <- bind_rows(cont_m4, break_row_m4, cat_m4) %>%
#   mutate(variable_clean = fct_inorder(c("T1D GRS",
#                                         "HbA1c at diagnosis (mmol/mol)",
#                                         #"C-peptide at visit 1 (pmol/l)",
#                                         "BMI at diagnosis (kg/m2)",

...
`1_ci`$prob_label
`0_ci`$prob_label
b_4to50 <- prop.test(x=2, n=2, conf.level = 0.95, correct = FALSE)
b_50plus <- prop.test(x=4, n=4, conf.level = 0.95, correct = FALSE)
`2_ci` <- `2_ci` %>%
  mutate(
    lcl_row = ifelse(prob3 == "0.4-0.5", b_4to50$conf.int[1]*100,
                     ifelse(prob3 == ">=0.5", b_50plus$conf.int[1]*100,lcl_row)),
    ucl_row = ifelse(prob3 == "0.4-0.5", b_4to50$conf.int[2]*100,
                     ifelse(prob3 == ">=0.5", b_50plus$conf.int[2]*100,ucl_row))
  )
...
pdf("figures/Supp_Figure36.pdf", height = 16, width = 24)
...
print(joint_plot)
dev.off()
#ggsave("figures/Supp_Figure36_prog_ins.png", joint_plot, height = 16, width = 24)
ggsave("figures/Supp_Figure36.jpeg", joint_plot, height = 16, width = 24)

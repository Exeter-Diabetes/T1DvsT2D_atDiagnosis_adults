...
pdf("figures/Supp_Figure34.pdf", height = 16, width = 24)
...
print(joint_plot)
dev.off()
#ggsave("figures/Figure5_T1Dcode.png", joint_plot, height = 16, width = 24)
ggsave("figures/Supp_Figure34.jpeg", joint_plot, height = 16, width = 24)
